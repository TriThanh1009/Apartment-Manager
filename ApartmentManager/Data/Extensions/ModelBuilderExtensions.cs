    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelbuilder)
        {
            ...
            modelbuilder.Entity<RoomDetails>().HasData(
                new RoomDetails { IDFur = 1, IDRoom = 1, IDImage = 2 },
                new RoomDetails { IDFur = 2, IDRoom = 2, IDImage = 3 },
                new RoomDetails { IDFur = 3, IDRoom = 3, IDImage = 1 },
                new RoomDetails { IDFur = 2, IDRoom = 4, IDImage = 1 },
                new RoomDetails { IDFur = 3, IDRoom = 5, IDImage = 3 },
                new RoomDetails { IDFur = 1, IDRoom = 6, IDImage = 2 },
                new RoomDetails { IDFur = 3, IDRoom = 7, IDImage = 1 }
                );
