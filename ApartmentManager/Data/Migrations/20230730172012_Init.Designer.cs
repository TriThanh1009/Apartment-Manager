            ...
            modelBuilder.Entity("Data.Entity.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("PayDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 7, 31, 0, 20, 11, 457, DateTimeKind.Local).AddTicks(6687));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IDRTC = 1,
                            PayDate = new DateTime(2023, 7, 31, 0, 20, 11, 474, DateTimeKind.Local).AddTicks(7145),
                            TotalMoney = 1000000
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.DepositsContract", b =>
                {
                    ...
                    b.Property<DateTime>("DepositsDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 31, 0, 20, 11, 458, DateTimeKind.Local).AddTicks(6149));
                    ...
                    b.Property<DateTime>("ReceiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 31, 0, 20, 11, 458, DateTimeKind.Local).AddTicks(6775));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CheckOutDate = new DateTime(2023, 7, 31, 0, 20, 11, 474, DateTimeKind.Local).AddTicks(7206),
                            DepositsDate = new DateTime(2023, 7, 31, 0, 20, 11, 474, DateTimeKind.Local).AddTicks(7201),
                            IDRoom = 1,
                            Money = 10000,
                            ReceiveDate = new DateTime(2023, 7, 31, 0, 20, 11, 474, DateTimeKind.Local).AddTicks(7204)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.PaymentExtension", b =>
                {
                    ...
                    b.Property<DateTime>("Days")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 31, 0, 20, 11, 459, DateTimeKind.Local).AddTicks(5558));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Days = new DateTime(2023, 7, 31, 0, 20, 11, 474, DateTimeKind.Local).AddTicks(7277),
                            IDBill = 1
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.People", b =>
                {
                    ...
                    b.Property<DateTime>("Birthday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 31, 0, 20, 11, 465, DateTimeKind.Local).AddTicks(224));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Address = "Vietnam",
                            Birthday = new DateTime(2023, 7, 31, 0, 20, 11, 474, DateTimeKind.Local).AddTicks(7315),
            ...
            modelBuilder.Entity("Data.Entity.RentalContract", b =>
                {
                    ...
                    b.Property<DateTime>("CheckOutDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 31, 0, 20, 11, 470, DateTimeKind.Local).AddTicks(8467));
                    ...
                    b.Property<DateTime>("ReceiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 7, 31, 0, 20, 11, 470, DateTimeKind.Local).AddTicks(7393));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CheckOutDate = new DateTime(2023, 7, 31, 0, 20, 11, 474, DateTimeKind.Local).AddTicks(7358),
                            ElectricMoney = 100,
                            IDLeader = 1,
                            IDroom = 1,
                            ReceiveDate = new DateTime(2023, 7, 31, 0, 20, 11, 474, DateTimeKind.Local).AddTicks(7357),
                            RoomMoney = 100,
                            ServiceMoney = 100,
                            WaterMoney = 100
                        });
