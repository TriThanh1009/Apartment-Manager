        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthday = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 11, 6, 9, 26, 6, 804, DateTimeKind.Local).AddTicks(7310)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositsDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 11, 6, 9, 26, 6, 804, DateTimeKind.Local).AddTicks(771)),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 11, 6, 9, 26, 6, 804, DateTimeKind.Local).AddTicks(1107)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IDroom = table.Column<int>(type: "int", nullable: false),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 11, 6, 9, 26, 6, 805, DateTimeKind.Local).AddTicks(1499)),
                    CheckOutDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 11, 6, 9, 26, 6, 805, DateTimeKind.Local).AddTicks(1852)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 11, 6, 9, 26, 6, 802, DateTimeKind.Local).AddTicks(9342)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Days = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 11, 6, 9, 26, 6, 804, DateTimeKind.Local).AddTicks(5708))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vietnam", new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8996), "thanh@gmail.com", "1234123", "Jonhny Deep", "1234" },
                    { 2, "USA", new DateTime(1997, 6, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "emily@gmail.com", "56781234", "Emily Stone", "5678" },
                    { 3, "Canada", new DateTime(1994, 12, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "robert@gmail.com", "910111213", "Robert Smith", "91011" },
                    { 4, "Australia", new DateTime(1990, 1, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), "anna@gmail.com", "14151617", "Anna Johnson", "1415" },
                    { 5, "UK", new DateTime(1997, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "michael@gmail.com", "18192021", "Michael Brown", "1819" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8947), new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8945), 1, 10000, new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8947) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(9093), 100, 1, null, new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(9092), 100, 100, 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 150, 1, new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8924), 1000000.0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8981), 1 });
