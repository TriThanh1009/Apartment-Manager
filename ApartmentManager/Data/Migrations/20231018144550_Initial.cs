        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthday = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 18, 21, 45, 50, 288, DateTimeKind.Local).AddTicks(4802)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositsDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 18, 21, 45, 50, 287, DateTimeKind.Local).AddTicks(8067)),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 18, 21, 45, 50, 287, DateTimeKind.Local).AddTicks(8406)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IDroom = table.Column<int>(type: "int", nullable: false),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 18, 21, 45, 50, 288, DateTimeKind.Local).AddTicks(9134)),
                    CheckOutDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 18, 21, 45, 50, 288, DateTimeKind.Local).AddTicks(9496)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 18, 21, 45, 50, 287, DateTimeKind.Local).AddTicks(3993)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Days = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 18, 21, 45, 50, 288, DateTimeKind.Local).AddTicks(2752))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vietnam", new DateTime(2023, 10, 18, 21, 45, 50, 291, DateTimeKind.Local).AddTicks(5099), "thanh@gmail.com", "1234123", "Jonhny Deep", "1234" },
                    { 2, "USA", new DateTime(1990, 7, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "emily@gmail.com", "56781234", "Emily Stone", "5678" },
                    { 3, "Canada", new DateTime(1990, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), "robert@gmail.com", "910111213", "Robert Smith", "91011" },
                    { 4, "Australia", new DateTime(1996, 9, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "anna@gmail.com", "14151617", "Anna Johnson", "1415" },
                    { 5, "UK", new DateTime(1998, 7, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "michael@gmail.com", "18192021", "Michael Brown", "1819" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 18, 21, 45, 50, 291, DateTimeKind.Local).AddTicks(5051), new DateTime(2023, 10, 18, 21, 45, 50, 291, DateTimeKind.Local).AddTicks(5049), 1, 10000, new DateTime(2023, 10, 18, 21, 45, 50, 291, DateTimeKind.Local).AddTicks(5050) });

            migrationBuilder.InsertData(
                table: "RentalContract",
                columns: new[] { "ID", "CheckOutDate", "ElectricMoney", "IDroom", "PeopleID", "ReceiveDate", "RoomMoney", "ServiceMoney", "WaterMoney" },
                values: new object[] { 1, new DateTime(2023, 10, 18, 21, 45, 50, 291, DateTimeKind.Local).AddTicks(5199), 100, 1, null, new DateTime(2023, 10, 18, 21, 45, 50, 291, DateTimeKind.Local).AddTicks(5197), 100, 100, 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 150, 1, new DateTime(2023, 10, 18, 21, 45, 50, 291, DateTimeKind.Local).AddTicks(5026), 1000000 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 18, 21, 45, 50, 291, DateTimeKind.Local).AddTicks(5083), 1 });
