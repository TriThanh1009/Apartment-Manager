        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositsDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 2, 18, 55, 53, 802, DateTimeKind.Local).AddTicks(5877)),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 2, 18, 55, 53, 802, DateTimeKind.Local).AddTicks(6204)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthday = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 2, 18, 55, 53, 803, DateTimeKind.Local).AddTicks(4568)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDroom = table.Column<int>(type: "int", nullable: false),
                    IDLeader = table.Column<int>(type: "int", nullable: false),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 2, 18, 55, 53, 803, DateTimeKind.Local).AddTicks(8546)),
                    CheckOutDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 2, 18, 55, 53, 803, DateTimeKind.Local).AddTicks(8881)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 2, 18, 55, 53, 802, DateTimeKind.Local).AddTicks(2290)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Days = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 9, 2, 18, 55, 53, 803, DateTimeKind.Local).AddTicks(462))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 9, 2, 18, 55, 53, 805, DateTimeKind.Local).AddTicks(3466), new DateTime(2023, 9, 2, 18, 55, 53, 805, DateTimeKind.Local).AddTicks(3464), 1, 10000, new DateTime(2023, 9, 2, 18, 55, 53, 805, DateTimeKind.Local).AddTicks(3465) });

            migrationBuilder.InsertData(
                table: "People",
                columns: new[] { "ID", "Address", "Birthday", "Email", "IDCard", "IDroom", "Name", "PhoneNumber" },
                values: new object[] { 1, "Vietnam", new DateTime(2023, 9, 2, 18, 55, 53, 805, DateTimeKind.Local).AddTicks(3504), "thanh@gmail.com", "1234123", 1, "Jonhny Deep", "1234" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 9, 2, 18, 55, 53, 805, DateTimeKind.Local).AddTicks(3522), 100, 1, 1, null, new DateTime(2023, 9, 2, 18, 55, 53, 805, DateTimeKind.Local).AddTicks(3521), 100, 100, 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, 150, 1, new DateTime(2023, 9, 2, 18, 55, 53, 805, DateTimeKind.Local).AddTicks(3445), 1000000 });

            migrationBuilder.InsertData(
                table: "PaymentExtension",
                columns: new[] { "ID", "Days", "IDBill" },
                values: new object[] { 1, new DateTime(2023, 9, 2, 18, 55, 53, 805, DateTimeKind.Local).AddTicks(3488), 1 });
