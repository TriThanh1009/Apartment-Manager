...
namespace Data.Migrations
{
    ...
    [Migration("20231106022606_Initial")]
            ...
            modelBuilder.Entity("Data.Entity.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("PayDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 6, 9, 26, 6, 802, DateTimeKind.Local).AddTicks(9342));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IDRTC = 1,
                            PayDate = new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8924),
            ...
            modelBuilder.Entity("Data.Entity.DepositsContract", b =>
                {
                    ...
                    b.Property<DateTime>("DepositsDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 6, 9, 26, 6, 804, DateTimeKind.Local).AddTicks(771));
                    ...
                    b.Property<DateTime>("ReceiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 6, 9, 26, 6, 804, DateTimeKind.Local).AddTicks(1107));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CheckOutDate = new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8947),
                            DepositsDate = new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8945),
                            IDRoom = 1,
                            Money = 10000,
                            ReceiveDate = new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8947)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.PaymentExtension", b =>
                {
                    ...
                    b.Property<DateTime>("Days")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 6, 9, 26, 6, 804, DateTimeKind.Local).AddTicks(5708));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Days = new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8981),
                            IDBill = 1
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.People", b =>
                {
                    ...
                    b.Property<DateTime>("Birthday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 6, 9, 26, 6, 804, DateTimeKind.Local).AddTicks(7310));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Address = "Vietnam",
                            Birthday = new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(8996),
                        ...
                        new
                        {
                            ID = 2,
                            Address = "USA",
                            Birthday = new DateTime(1997, 6, 17, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = 3,
                            Address = "Canada",
                            Birthday = new DateTime(1994, 12, 4, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = 5,
                            Address = "UK",
                            Birthday = new DateTime(1997, 5, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Data.Entity.RentalContract", b =>
                {
                    ...
                    b.Property<DateTime>("CheckOutDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 6, 9, 26, 6, 805, DateTimeKind.Local).AddTicks(1852));
                    ...
                    b.Property<DateTime>("ReceiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 6, 9, 26, 6, 805, DateTimeKind.Local).AddTicks(1499));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Active = 0,
                            CheckOutDate = new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(9093),
                            ElectricMoney = 100,
                            IDroom = 1,
                            ReceiveDate = new DateTime(2023, 11, 6, 9, 26, 6, 807, DateTimeKind.Local).AddTicks(9092),
                            RoomMoney = 100,
                            ServiceMoney = 100,
                            WaterMoney = 100
                        });
