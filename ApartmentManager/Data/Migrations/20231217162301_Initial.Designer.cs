...
namespace Data.Migrations
{
    ...
    [Migration("20231217162301_Initial")]
            ...
            modelBuilder.Entity("Data.Entity.Bill", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IDRTC = 1,
                            PayDate = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8165),
            ...
            modelBuilder.Entity("Data.Entity.DepositsContract", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CheckOutDate = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8193),
                            DepositsDate = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8190),
                            IDLeader = 1,
                            IDRoom = 1,
                            Money = 10000,
                            ReceiveDate = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8191)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.PaymentExtension", b =>
                {
                    ...
                    b.Property<DateTime>("Days")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 12, 17, 23, 23, 1, 355, DateTimeKind.Local).AddTicks(8510));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Days = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8228),
                            IDBill = 1
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.People", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Address = "Vietnam",
                            Birthday = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8251),
                        ...
                        new
                        {
                            ID = 2,
                            Address = "USA",
                            Birthday = new DateTime(1993, 5, 26, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = 3,
                            Address = "Canada",
                            Birthday = new DateTime(1991, 5, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = 4,
                            Address = "Australia",
                            Birthday = new DateTime(1993, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Data.Entity.RentalContract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Active = 1,
                            CheckOutDate = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8384),
                            ElectricMoney = 100,
                            IDroom = 1,
                            ReceiveDate = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8383),
                            RoomMoney = 100,
                            ServiceMoney = 100,
                            WaterMoney = 100
                        },
                        new
                        {
                            ID = 2,
                            Active = 1,
                            CheckOutDate = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8389),
                            ElectricMoney = 100,
                            IDroom = 2,
                            ReceiveDate = new DateTime(2023, 12, 17, 23, 23, 1, 359, DateTimeKind.Local).AddTicks(8388),
                            RoomMoney = 100,
                            ServiceMoney = 100,
                            WaterMoney = 100
                        });
