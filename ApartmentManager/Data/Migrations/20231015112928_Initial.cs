        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthday = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 15, 18, 29, 28, 36, DateTimeKind.Local).AddTicks(7922)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositsDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 15, 18, 29, 28, 35, DateTimeKind.Local).AddTicks(9656)),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 15, 18, 29, 28, 36, DateTimeKind.Local).AddTicks(220)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 15, 18, 29, 28, 37, DateTimeKind.Local).AddTicks(2994)),
                    CheckOutDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 15, 18, 29, 28, 37, DateTimeKind.Local).AddTicks(3357)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 15, 18, 29, 28, 35, DateTimeKind.Local).AddTicks(5432)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Days = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 15, 18, 29, 28, 36, DateTimeKind.Local).AddTicks(5904))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vietnam", new DateTime(2023, 10, 15, 18, 29, 28, 40, DateTimeKind.Local).AddTicks(1123), "thanh@gmail.com", "1234123", "Jonhny Deep", "1234" },
                    { 2, "USA", new DateTime(1994, 5, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "emily@gmail.com", "56781234", "Emily Stone", "5678" },
                    { 3, "Canada", new DateTime(2000, 3, 24, 0, 0, 0, 0, DateTimeKind.Unspecified), "robert@gmail.com", "910111213", "Robert Smith", "91011" },
                    { 4, "Australia", new DateTime(2000, 9, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), "anna@gmail.com", "14151617", "Anna Johnson", "1415" },
                    { 5, "UK", new DateTime(1999, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "michael@gmail.com", "18192021", "Michael Brown", "1819" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 15, 18, 29, 28, 40, DateTimeKind.Local).AddTicks(1081), new DateTime(2023, 10, 15, 18, 29, 28, 40, DateTimeKind.Local).AddTicks(1079), 1, 10000, new DateTime(2023, 10, 15, 18, 29, 28, 40, DateTimeKind.Local).AddTicks(1080) });

            migrationBuilder.InsertData(
                table: "RentalContract",
                columns: new[] { "ID", "Active", "CheckOutDate", "ElectricMoney", "IDLeader", "IDroom", "PeopleID", "ReceiveDate", "RoomMoney", "ServiceMoney", "WaterMoney" },
                values: new object[] { 1, 0, new DateTime(2023, 10, 15, 18, 29, 28, 40, DateTimeKind.Local).AddTicks(1219), 100, 1, 1, null, new DateTime(2023, 10, 15, 18, 29, 28, 40, DateTimeKind.Local).AddTicks(1217), 100, 100, 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 150, 1, new DateTime(2023, 10, 15, 18, 29, 28, 40, DateTimeKind.Local).AddTicks(1057), 1000000 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 15, 18, 29, 28, 40, DateTimeKind.Local).AddTicks(1108), 1 });
