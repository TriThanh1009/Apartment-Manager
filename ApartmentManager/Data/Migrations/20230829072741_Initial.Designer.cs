...
namespace Data.Migrations
{
    ...
    [Migration("20230829072741_Initial")]
            ...
            modelBuilder.Entity("Data.Entity.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("PayDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 29, 14, 27, 41, 569, DateTimeKind.Local).AddTicks(540));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IDRTC = 1,
                            PayDate = new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(771),
                            TotalMoney = 1000000
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.DepositsContract", b =>
                {
                    ...
                    b.Property<DateTime>("DepositsDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 29, 14, 27, 41, 569, DateTimeKind.Local).AddTicks(3913));
                    ...
                    b.Property<DateTime>("ReceiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 29, 14, 27, 41, 569, DateTimeKind.Local).AddTicks(4225));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CheckOutDate = new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(792),
                            DepositsDate = new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(791),
                            IDRoom = 1,
                            Money = 10000,
                            ReceiveDate = new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(791)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.PaymentExtension", b =>
                {
                    ...
                    b.Property<DateTime>("Days")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 29, 14, 27, 41, 569, DateTimeKind.Local).AddTicks(8198));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Days = new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(817),
                            IDBill = 1
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.People", b =>
                {
                    ...
                    b.Property<DateTime>("Birthday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 29, 14, 27, 41, 570, DateTimeKind.Local).AddTicks(2217));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Address = "Vietnam",
                            Birthday = new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(830),
            ...
            modelBuilder.Entity("Data.Entity.RentalContract", b =>
                {
                    ...
                    b.Property<DateTime>("CheckOutDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 29, 14, 27, 41, 570, DateTimeKind.Local).AddTicks(6506));
                    ...
                    b.Property<DateTime>("ReceiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 29, 14, 27, 41, 570, DateTimeKind.Local).AddTicks(6173));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CheckOutDate = new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(845),
                            ElectricMoney = 100,
                            IDLeader = 1,
                            IDroom = 1,
                            ReceiveDate = new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(845),
                            RoomMoney = 100,
                            ServiceMoney = 100,
                            WaterMoney = 100
                        });
