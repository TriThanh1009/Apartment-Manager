        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthday = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 24, 15, 25, 2, 789, DateTimeKind.Local).AddTicks(2013)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositsDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 24, 15, 25, 2, 788, DateTimeKind.Local).AddTicks(5540)),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 24, 15, 25, 2, 788, DateTimeKind.Local).AddTicks(5855)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IDroom = table.Column<int>(type: "int", nullable: false),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 24, 15, 25, 2, 789, DateTimeKind.Local).AddTicks(5992)),
                    CheckOutDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 24, 15, 25, 2, 789, DateTimeKind.Local).AddTicks(6382)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 24, 15, 25, 2, 788, DateTimeKind.Local).AddTicks(1943)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Days = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 10, 24, 15, 25, 2, 789, DateTimeKind.Local).AddTicks(600))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vietnam", new DateTime(2023, 10, 24, 15, 25, 2, 791, DateTimeKind.Local).AddTicks(9060), "thanh@gmail.com", "1234123", "Jonhny Deep", "1234" },
                    { 2, "USA", new DateTime(1990, 9, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), "emily@gmail.com", "56781234", "Emily Stone", "5678" },
                    { 3, "Canada", new DateTime(2000, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "robert@gmail.com", "910111213", "Robert Smith", "91011" },
                    { 4, "Australia", new DateTime(1990, 10, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "anna@gmail.com", "14151617", "Anna Johnson", "1415" },
                    { 5, "UK", new DateTime(2000, 8, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), "michael@gmail.com", "18192021", "Michael Brown", "1819" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 24, 15, 25, 2, 791, DateTimeKind.Local).AddTicks(9021), new DateTime(2023, 10, 24, 15, 25, 2, 791, DateTimeKind.Local).AddTicks(9019), 1, 10000, new DateTime(2023, 10, 24, 15, 25, 2, 791, DateTimeKind.Local).AddTicks(9021) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, new DateTime(2023, 10, 24, 15, 25, 2, 791, DateTimeKind.Local).AddTicks(9161), 100, 1, null, new DateTime(2023, 10, 24, 15, 25, 2, 791, DateTimeKind.Local).AddTicks(9160), 100, 100, 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 150, 1, new DateTime(2023, 10, 24, 15, 25, 2, 791, DateTimeKind.Local).AddTicks(9001), 1000000 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 10, 24, 15, 25, 2, 791, DateTimeKind.Local).AddTicks(9044), 1 });
