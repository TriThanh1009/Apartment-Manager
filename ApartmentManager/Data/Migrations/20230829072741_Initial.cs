        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DepositsDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 29, 14, 27, 41, 569, DateTimeKind.Local).AddTicks(3913)),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 29, 14, 27, 41, 569, DateTimeKind.Local).AddTicks(4225)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Birthday = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 29, 14, 27, 41, 570, DateTimeKind.Local).AddTicks(2217)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IDroom = table.Column<int>(type: "int", nullable: false),
                    IDLeader = table.Column<int>(type: "int", nullable: false),
                    ReceiveDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 29, 14, 27, 41, 570, DateTimeKind.Local).AddTicks(6173)),
                    CheckOutDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 29, 14, 27, 41, 570, DateTimeKind.Local).AddTicks(6506)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 29, 14, 27, 41, 569, DateTimeKind.Local).AddTicks(540)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Days = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 8, 29, 14, 27, 41, 569, DateTimeKind.Local).AddTicks(8198))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(792), new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(791), 1, 10000, new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(791) });

            migrationBuilder.InsertData(
                table: "People",
                columns: new[] { "ID", "Address", "Birthday", "Email", "IDCard", "IDroom", "Name", "PhoneNumber" },
                values: new object[] { 1, "Vietnam", new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(830), "thanh@gmail.com", "1234123", 1, "Jonhny Deep", "1234" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(845), 100, 1, 1, null, new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(845), 100, 100, 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 0, 150, 1, new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(771), 1000000 });

            migrationBuilder.InsertData(
                table: "PaymentExtension",
                columns: new[] { "ID", "Days", "IDBill" },
                values: new object[] { 1, new DateTime(2023, 8, 29, 14, 27, 41, 572, DateTimeKind.Local).AddTicks(817), 1 });
