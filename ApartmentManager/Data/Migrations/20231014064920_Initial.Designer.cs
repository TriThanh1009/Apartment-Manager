...
namespace Data.Migrations
{
    ...
    [Migration("20231014064920_Initial")]
            ...
            modelBuilder.Entity("Data.Entity.Bill", b =>
                {
                    ...
                    b.Property<DateTime>("PayDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 14, 13, 49, 19, 986, DateTimeKind.Local).AddTicks(1950));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IDRTC = 1,
                            PayDate = new DateTime(2023, 10, 14, 13, 49, 19, 990, DateTimeKind.Local).AddTicks(2077),
                            TotalMoney = 1000000
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.DepositsContract", b =>
                {
                    ...
                    b.Property<DateTime>("DepositsDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 14, 13, 49, 19, 986, DateTimeKind.Local).AddTicks(5398));
                    ...
                    b.Property<DateTime>("ReceiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 14, 13, 49, 19, 986, DateTimeKind.Local).AddTicks(5699));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CheckOutDate = new DateTime(2023, 10, 14, 13, 49, 19, 990, DateTimeKind.Local).AddTicks(2129),
                            DepositsDate = new DateTime(2023, 10, 14, 13, 49, 19, 990, DateTimeKind.Local).AddTicks(2126),
                            IDRoom = 1,
                            Money = 10000,
                            ReceiveDate = new DateTime(2023, 10, 14, 13, 49, 19, 990, DateTimeKind.Local).AddTicks(2127)
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.PaymentExtension", b =>
                {
                    ...
                    b.Property<DateTime>("Days")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 14, 13, 49, 19, 987, DateTimeKind.Local).AddTicks(540));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            Days = new DateTime(2023, 10, 14, 13, 49, 19, 990, DateTimeKind.Local).AddTicks(2169),
                            IDBill = 1
                        });
                });
            ...
            modelBuilder.Entity("Data.Entity.People", b =>
                {
                    ...
                    b.Property<DateTime>("Birthday")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 14, 13, 49, 19, 987, DateTimeKind.Local).AddTicks(1905));
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Address = "Vietnam",
                            Birthday = new DateTime(2023, 10, 14, 13, 49, 19, 990, DateTimeKind.Local).AddTicks(2251),
                        ...
                        new
                        {
                            ID = 4,
                            Address = "Australia",
                            Birthday = new DateTime(1999, 2, 17, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            ID = 5,
                            Address = "UK",
                            Birthday = new DateTime(1995, 2, 13, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Data.Entity.RentalContract", b =>
                {
                    ...
                    b.Property<DateTime>("CheckOutDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 14, 13, 49, 19, 987, DateTimeKind.Local).AddTicks(6085));
                    ...
                    b.Property<DateTime>("ReceiveDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 14, 13, 49, 19, 987, DateTimeKind.Local).AddTicks(5776));
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CheckOutDate = new DateTime(2023, 10, 14, 13, 49, 19, 990, DateTimeKind.Local).AddTicks(2657),
                            ElectricMoney = 100,
                            IDLeader = 1,
                            IDroom = 1,
                            ReceiveDate = new DateTime(2023, 10, 14, 13, 49, 19, 990, DateTimeKind.Local).AddTicks(2656),
                            RoomMoney = 100,
                            ServiceMoney = 100,
                            WaterMoney = 100
                        });
