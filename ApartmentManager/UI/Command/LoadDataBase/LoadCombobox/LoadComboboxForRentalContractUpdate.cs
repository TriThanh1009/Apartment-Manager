...
{
    public class LoadComboboxForRentalContractUpdate : AsyncCommandBase
    {
        private readonly RentalContractUpdateVMUI _rentalvmui;
        private readonly ComboboxStore _Store;

        public LoadComboboxForRentalContractUpdate(RentalContractUpdateVMUI rentalvmui, ComboboxStore store)
        {
